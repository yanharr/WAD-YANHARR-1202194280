...
<body>
    ...
    <p>
        ...
        <center> <button type="submit" class="btn btn-primary my-1">Add Vaccine</button>
        </center>
    </p>

    <h2>
        <center>Input Vaccine</center>
    </h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <button type="submit" class="btn btn-primary my-1">Add Vaccine</button>
                <table class="table" style="background-color:lightblue;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>-</td>
                            <td>
                                <button type="submit" class="btn btn-primary my-1 text-dark bg-warning">Edit</button>
                                <button type="submit" class="btn btn-primary my-1 bg-danger">Delete</button>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
