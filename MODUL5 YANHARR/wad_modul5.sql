...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Des 2021 pada 12.06
...
(5, '2021_12_11_085538_create_vaccines_table', 1),
(6, '2021_12_11_085539_create_patients_table', 1);
...
--
ALTER TABLE `patients`
  ADD CONSTRAINT `patients_vaccine_id_foreign` FOREIGN KEY (`vaccine_id`) REFERENCES `vaccines` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
